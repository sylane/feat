...
class TestApplicationJSON(common.TestCase):
    ...
    def check(self, obj, expected, exp_type=None, encoding="UTF8", verbose=False):
    ...
    def testEncodings(self):
        ...
        yield check_write("utf8", "áéíóú", json_uni) # module encoding is utf8
